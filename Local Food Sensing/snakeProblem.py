...
def main():
	...
	# Attribute generator
	toolbox.register("expr_init", gp.genGrow, pset=pset, min_=1, max_=6)
	...
	pop, log = algorithms.eaMuPlusLambda(pop, toolbox, MU, LAMBDA, MUTPB, CXPB, NGEN, stats, halloffame=hof)
